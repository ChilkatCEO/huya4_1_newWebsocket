...
namespace HUYA
{
    public sealed class UserChannelReq:JceStruct
    {
        ...
        public override void ReadFrom(JceInputStream _is)
        {
            ...
            this.sSendContent = _is.Read(this.sSendContent, 3, false);
        }
