...
namespace Wup
{
	internal class Const
	{
		...
		public static byte PACKET_TYPE_JCENORMAL = 0;

		public static byte PACKET_TYPE_JCEONEWAY = 1;

		public static byte PACKET_TYPE_WUP = 2;

		public static byte PACKET_TYPE_WUP3 = 3;
	}
}
