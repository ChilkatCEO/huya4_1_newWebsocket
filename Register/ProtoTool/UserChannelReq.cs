...
namespace iHuya.ProtoTool
{
    class UserChannelReq
    {
        ...
        public UserChannelReq(string sCookie, long lUid, long topsid, long subsid)
        {
        ...
        public byte[] marshall()
        {
           ...
           // IArrayBuffer i = (IArrayBuffer)(v8.Script.getUserIn(sCookie, lUid, topsid, subsid));
           // result = i.GetBytes();
            return result;
        }
